...
class AdminConfigServiceTest {
    ...
    void testConfigurePerformanceCycles() throws Exception {
        mockedInputUtil.when(() -> InputUtil.readString(contains("Cycle Name"))).thenReturn("2024 Cycle");
        ...
        verify(mockCycleDao).createCycle(eq("2024 Cycle"), any(Date.class), any(Date.class));
    }
