...
public class VerifyTeamDisplay {
    public static void main(String[] args) {
        try {
            ...
            System.out.println("Searching for Manager 'John Doe'...");
            ...
            while (rs.next()) {
                if (rs.getString("first_name").equalsIgnoreCase("John")
                    ...
                    System.out.println("Found Manager: " + managerId);
                    break;
                }
            }

            if (managerId != null) {
                System.out.println("Displaying Team for ID: " + managerId);
                ManagerService.viewTeam(managerId);
            } else {
                System.out.println("Manager John Doe not found. Trying to find any manager with reportees...");
                ...
                System.out.println("Trying 'MGR001'...");
